...
class AttendanceScreen extends StatefulWidget {
  ...
  AttendanceScreen({super.key, required this.userId, required this.userType, required this.userClass});
...
class _AttendanceScreenState extends State<AttendanceScreen>
  ...
  void initState() {
    ...
    if (widget.userType == priest) {
      stream = cubit.getUsersByType(widget.userClass, [superServant, servant, child]).asStream();
    } else if (widget.userType == superServant) {
      stream = cubit.getUsersByType(widget.userClass, [servant, child]).asStream();
    } else if (widget.userType == servant) {
      stream = cubit.getUsersByType(widget.userClass, [child]).asStream();
    } else {
