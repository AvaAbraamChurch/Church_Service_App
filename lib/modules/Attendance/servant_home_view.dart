...
/// Replaces the old horizontal TabBar approach for servant / super-servant / priest.
class ServantHomeView extends StatelessWidget {
  final AttendanceCubit cubit;
  final UserType userType;
  final Gender gender;

  const ServantHomeView({
    super.key,
    required this.cubit,
...
class _GreetingBanner extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final name = cubit.currentUser?.fullName ?? 'الخادم';
