...
import 'package:church/core/constants/strings.dart' as strings;
...
class VisitPriestView extends StatefulWidget {
  ...
  @override
  State<VisitPriestView> createState() => _VisitPriestViewState();
}

class _VisitPriestViewState extends State<VisitPriestView> {
  ...
  List<UserModel> get children {
    final allChildren =
        widget.users.where((u) => u.userType == UserType.child).toList()
