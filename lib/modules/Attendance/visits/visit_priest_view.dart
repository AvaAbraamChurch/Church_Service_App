...
class _VisitPriestViewState extends State<VisitPriestView> {
  ...
  List<UserModel> get children {
    final allChildren = widget.users
        .where((u) => u.userType == UserType.child)
        .toList()
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'تسجيل ومتابعة زيارات المخدومين',
                        style: TextStyle(
                          fontSize: 14,
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          // Reset selected child if not in filtered list
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: CheckboxListTile(
                            ...
                            subtitle: Text(
                              servant.userType == UserType.superServant ? strings.superServant : strings.servant,
          ...
          // Show all visits for all children
