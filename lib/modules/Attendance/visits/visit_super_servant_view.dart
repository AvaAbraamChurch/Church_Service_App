...
class _VisitSuperServantViewState extends State<VisitSuperServantView> {
  ...
  void _fetchUsersFromFirestore() {
    ...
    _usersSubscription = _usersRepository
        ...
        .listen(
          (users) {
            if (!mounted || _usersSubscription == null) return;
            setState(() {
          ...
          onError: (error) {
            if (mounted && _usersSubscription != null) setState(() => _isLoadingUsers = false);
          },
        );
    ...
    if (includePriests) {
      ...
      _priestsSubscription = _usersRepository
          ...
          .listen(
            (priests) {
              if (!mounted || _priestsSubscription == null) return;
              setState(() {
                _fetchedPriests =
            ...
            onError: (error) {
              if (mounted && _priestsSubscription != null) setState(() => _isLoadingUsers = false);
            },
          );
    } else {
      _fetchedPriests = [];
