  ...
  Future<void> _saveHymn() async {
    ...
    try {
      ...
      if (hymnId != null && mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('فشل في إضافة اللحن'),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _isLoadingClasses
                      ...
                      : Container(
                          ...
                          child: Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: _availableUserClasses.map((userClass) {
                              final isSelected = _selectedUserClasses.contains(
                                userClass,
                              );
                              return FilterChip(
                                ...
                                selectedColor: teal500.withValues(alpha: 0.3),
                                checkmarkColor: teal700,
                                labelStyle: TextStyle(
                                  color: isSelected ? teal700 : Colors.black87,
                  ...
                  // Save Button
                  ElevatedButton.icon(
                    onPressed: _isLoading ? null : _saveHymn,
                    icon: const Icon(Icons.save),
                    label: Text(_isLoading ? 'جاري الحفظ...' : 'حفظ اللحن'),
